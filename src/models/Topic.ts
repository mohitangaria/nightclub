...
interface TopicInstance extends Model<TopicInterface>, TopicInterface { 
...
const Topic = sequelize.define<TopicInstance>(
    "Topic",
    {
        ...
        topicFeaturedImage: { type: DataTypes.INTEGER, allowNull: true, defaultValue: null, comment: "Community logo" },
